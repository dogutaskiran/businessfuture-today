...
export function PublicationHeader({ template, pathname = "/" }: { template: PublicationTemplate; pathname?: string }) {
  return <>
    <div className="pub-utility"><div className="pub-shell pub-utility__inner"><span>The future of business, today.</span><div><Link href="/feed.xml">RSS</Link><a href="#briefing">Newsletters</a><a href="mailto:hello@businessfuture.today">Advertise</a></div></div></div>
...
export function PublicationFooter({ template }: { template: PublicationTemplate }) {
  return <footer className="pub-footer">
    <div className="pub-shell pub-footer__grid">
      ...
      <div><h4>Products</h4><a href="#briefing">Daily Briefing</a><Link href="/feed.xml">RSS Feed</Link><a href="mailto:hello@businessfuture.today">Advertise</a></div>
      <div><h4>Business Future Today</h4><a href="mailto:hello@businessfuture.today">Contact</a><span>© {new Date().getFullYear()}</span></div>
    </div>
  </footer>;
}
